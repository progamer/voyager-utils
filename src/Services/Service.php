...
namespace Codept\Core\Services;
...
class Service
{
    ...
    public function getContentBasedOnType($request, $slug, $row, $options = null)
    {
        switch ($row->type) {
            /********** PASSWORD TYPE **********/
            case 'password':
    ...
    public function insertUpdateData($request, $slug, $rows, $data)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($row->type == 'translate' && !is_null($content)) {
    ...
    public function getBreadValidation($request, $data, $name = null, $id = null)
    {
        $rules = [];
        $messages = [];
        $customAttributes = [];
